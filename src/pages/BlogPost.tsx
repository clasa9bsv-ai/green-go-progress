...
const BlogPost = () => {
  ...
  const fetchPost = async () => {
    ...
    if (error) {
      toast.error("Eroare la încărcarea postării");
      navigate("/blog");
    } else {
      setPost(data);
    }
  ...
  const handleLike = async () => {
    if (!user) {
      toast.error("Trebuie să fii autentificat pentru a aprecia");
      return;
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <Card className="shadow-medium mb-8">
          <CardHeader>
            <CardTitle className="text-xl">Adaugă un comentariu</CardTitle>
          </CardHeader>
          <CardContent>
