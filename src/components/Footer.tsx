...
export const Footer = () => {
  ...
  return (
    <footer id="contact" className="bg-card border-t border-border mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              Transformăm grija față de mediu într-o experiență gamificată, 
              ajutând utilizatorii să adopte obiceiuri sustenabile prin provocări 
              zilnice și recompense. Fiecare acțiune contează pentru un viitor mai verde! 🌱
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <a 
                href="mailto:contact@greenandgo.ro" 
