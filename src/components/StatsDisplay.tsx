    ...
    <div className="space-y-4 mb-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <StatCard
          ...
          gradient
          subtitle={`${pointsInCurrentLevel}/${pointsNeededForNextLevel} pentru nivel ${stats.currentLevel + 1}`}
        />
        <StatCard
        ...
        <StatCard
          ...
          subtitle={stats.currentLevel < nextRewardLevel 
            ? `${pointsNeededForReward} puncte până la nivel ${nextRewardLevel}` 
            : "Premiu disponibil! 🎉"
          }
        />
      </div>
        ...
        <CardContent className="pt-6">
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground">Progres către nivelul {stats.currentLevel + 1}</span>
